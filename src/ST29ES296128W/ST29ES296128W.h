...
#ifndef _ST29ES296128W_H_
#define _ST29ES296128W_H_

#include "../GxEPD.h"

#define ST29ES296128W_WIDTH 128
#define ST29ES296128W_HEIGHT 296

#define ST29ES296128W_BUFFER_SIZE (uint32_t(ST29ES296128W_WIDTH) * uint32_t(ST29ES296128W_HEIGHT) / 8)

// divisor for AVR, should be factor of ST29ES296128W_HEIGHT
#define ST29ES296128W_PAGES 8

#define ST29ES296128W_PAGE_HEIGHT (ST29ES296128W_HEIGHT / ST29ES296128W_PAGES)
#define ST29ES296128W_PAGE_SIZE (ST29ES296128W_BUFFER_SIZE / ST29ES296128W_PAGES)

class ST29ES296128W : public GxEPD
{
  public:
#if defined(ESP8266)
    //ST29ES296128W(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    // use pin numbers, other ESP8266 than Wemos may not use Dx names
    ST29ES296128W(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    ST29ES296128W(GxIO& io, int8_t rst = 9, int8_t busy = 7);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called ST29ES296128W_PAGES times
  ...
  private:
#if defined(__AVR)
    uint8_t _buffer[ST29ES296128W_PAGE_SIZE];
#else
    uint8_t _buffer[ST29ES296128W_BUFFER_SIZE];
#endif
    GxIO& IO;
...
#ifndef GxEPD_Class
#define GxEPD_Class ST29ES296128W
#define GxEPD_WIDTH ST29ES296128W_WIDTH
#define GxEPD_HEIGHT ST29ES296128W_HEIGHT
#define GxEPD_BitmapExamples <ST29ES296128W/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "ST29ES296128W/BitmapExamples.h"
#endif
